...
namespace JHLib.Util.Hash
{
    ...
    public class LinkKeyMap<T> where T : unmanaged, INumber<T>
    {
        private const int NULL = -1;
        private struct Entry { public T Key; public int Idx; public int Prev; public int Next; }
        ...
        public LinkKeyMap() => Initialize(MinPrime);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LinkKeyMap(int cap) => Initialize(GetPrime(cap));
        ...
        public ref struct RefEnumerator(LinkKeyMap<T> list)
        {
