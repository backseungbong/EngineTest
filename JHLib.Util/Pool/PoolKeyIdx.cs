...
namespace JHLib.Util.Pool
{
    ...
    internal struct EntryKeyIdx
    {
        public const int SIZE = 8;
        public int Key;
        public int Idx;
    }
    internal class PoolKeyIdx : IDisposable
    {
        ...
        public ref EntryKeyIdx GetEntry(int i) => ref AsT<EntryKeyIdx>(ref _pool.Space0, i * ENT_SIZE);

        public void Dispose() => _pool.Dispose();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal PoolKeyIdx() { _pool = new(); Initialize(HashUtil.MinPrime); }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal PoolKeyIdx(int cap) { _pool = new(); Initialize(HashUtil.GetPrime(cap)); }
        ...
        private void Resize()
        {
            ...
            ref var b0 = ref AsT<int>(ref ref0, cap * ENT_SIZE);
            ref var e0 = ref AsT<EntryKeyIdx>(ref ref0);
        ...
        public void Set(int key)
        {
            ...
            ref var e = ref AsT<EntryKeyIdx>(ref ref0, i * ENT_SIZE);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Get(int key, out int idx)
        {
            ref var ref0 = ref _pool.Space0;
            ...
            {
                i--;
            RE: ref var e = ref AsT<EntryKeyIdx>(ref ref0, i * ENT_SIZE);
